          ...
          <form @submit.prevent="submitForm" class="space-y-6">
            ...
            <div>
              ...
              >
                ...
                <option value="optimizacion">Optimización de Rendimiento</option>
        ...
        <div class="space-y-8">
          <div>
            ...
            <div class="space-y-6">
              <div class="flex items-start space-x-4">
                <div class="w-12 h-12 bg-[#4F46E5]/10 rounded-lg flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  ...
                  <p class="text-gray-600">+598 123 456 789</p>
                  <p class="text-gray-600">+598 987 654 321</p>
                </div>
              </div>
              ...
              <div class="flex items-start space-x-4">
                ...
                <div>
                  <h3 class="font-semibold text-gray-900">Email</h3>
                              <p class="text-gray-600">contact@uytechsolutions.com</p>
            <p class="text-gray-600">support@uytechsolutions.com</p>
                </div>
              </div>
              ...
              <div class="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p class="text-gray-600">Montevideo, Uruguay</p>
                  <p class="text-gray-600">Zona Centro</p>
                </div>
              </div>
          ...
          <div>
            ...
            <div class="flex space-x-4">
              <a href="#" class="w-12 h-12 bg-[#4F46E5]/10 rounded-lg flex items-center justify-center hover:bg-[#4F46E5]/20 transition-colors">
                <svg class="w-6 h-6 text-[#4F46E5]" fill="currentColor" viewBox="0 0 24 24">
